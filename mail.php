<?php
$email = 'visaminsk.by@gmail.com'; // адрес куда отправлять письмо, можно несколько через запятую
$subject = 'Новое сообщение с сайта '.$_SERVER['HTTP_HOST']; // тема письма
$message = 'Данные формы:'; // первая строчка письма
$smtp = 0; // отправлять ли через личный почтовый ящик, 1 - отправлять, 0 - через хостинг
$__smtp = array(
    "host" => 'smtp.gmail.com', // сервер отправки писем (SMTP)
    ...
    "addreply" => 'visaminsk.by@gmail.com', // адрес куда отвечать (обязательно)
    "username" => 'visaminsk.by@gmail.com', // логин почтового сервера
