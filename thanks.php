...
<body class="body">
  ...
  <div class="checks thanks-st">
    <div class="checks_cont container">
      <div class="form-wrapper-2">
        ...
        <div class="w-row">
          <div class="soc-col1 w-col w-col-6 w-col-stack">
            <div class="vidjet w-embed w-script">
  ...
  VK.Widgets.Group("vk_groups", {mode: 0, width: "250", height: "200", color1: 'FFFFFF', color2: '2B587A', color3: '5B7FA6'}, 114208711);
          ...
          <div class="soc-col2 w-col w-col-6 w-col-stack">
            <div class="st2 vidjet w-embed w-script">
              <div id="fb-root">
              </div>
              <script>
  (function(d, s, id) {
